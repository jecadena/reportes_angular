...
@Component({
  selector: 'app-estadistica-solicitantes',
  templateUrl: './estadistica-solicitantes.component.html',
  styleUrls: ['./estadistica-solicitantes.component.css']
})
export class EstadisticaSolicitantesComponent {
  ...
  submitForm(form: NgForm): void {
    ...
    if (this.validateForm(form)) {
      ...
      const url = `http://REMOTESERVER:9091/api/estadisticasolicitante/?co_cia=${co_cia}&co_tip_maestro_p=${co_tip_maestro}&co_maestro_p=${co_maestro}&co_reporte=${co_reporte}&fe_del=${fe_del}&fe_al=${fe_al}&fg_tipo_ruta=${fg_tipo_ruta}&fg_formato=${fg_formato}&fg_corporativo=${fg_corporativo}&co_tip_maestro_cl=${co_tip_maestro_cl}`;
