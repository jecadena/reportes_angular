...
@Component({
  selector: 'app-estadistica-hotel',
  templateUrl: './estadistica-hotel.component.html',
  styleUrls: ['./estadistica-hotel.component.css']
})
export class EstadisticaHotelComponent {
